...
// このファイルが参照している ../vendor/tonejs-json-sequencer.mjs は、
//   https://github.com/cat2151/tonejs-json-sequencer
// の main ブランチから生成された「ベンダリング済み（バンドル済み）」ESM です。
//
// CSP 制約によりランタイムで CDN / raw GitHub から直接ロードせず、
// 代わりに事前バンドルした成果物を同梱しています。
// 「最新版を常に利用する」ため、../vendor/tonejs-json-sequencer.mjs は CI で定期的に再生成してください。
import type { SequencerLib } from '../types';
import { SequencerNodes, playSequence } from '../vendor/tonejs-json-sequencer.mjs';
