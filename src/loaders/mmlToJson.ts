...
// このライブラリは src/vendor/tonejs-mml-to-json/ に同梱し、静的 import でロードする。
...
// 最新版への追従: src/vendor/tonejs-mml-to-json/ 配下のファイルをアップストリームから再ダウンロードする。
import { initWasm, mml2json as mml2jsonLib } from '../vendor/tonejs-mml-to-json/dist/index.js';
