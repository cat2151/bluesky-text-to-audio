// @vendored from cat2151/mmlabc-to-smf-rust (main branch, GitHub Pages build)
// Upstream: https://github.com/cat2151/mmlabc-to-smf-rust
// Upstream-File: mmlabc-to-smf-wasm/pkg/mmlabc_to_smf_wasm.js (wasm-pack build artifact)
// Upstream-SHA: 26c8679f2afa3909142fc89d5139d544eaab6506
// License: MIT (https://github.com/cat2151/mmlabc-to-smf-rust/blob/main/LICENSE)
//
// DO NOT EDIT this file manually. Re-download from GitHub Pages to update:
//   curl -fL -o src/vendor/mmlabc-to-smf-wasm/pkg/mmlabc_to_smf_wasm.js \
//     https://cat2151.github.io/mmlabc-to-smf-rust/mmlabc-to-smf-wasm/pkg/mmlabc_to_smf_wasm.js
//   curl -fL -o src/vendor/mmlabc-to-smf-wasm/pkg/mmlabc_to_smf_wasm_bg.wasm \
//     https://cat2151.github.io/mmlabc-to-smf-rust/mmlabc-to-smf-wasm/pkg/mmlabc_to_smf_wasm_bg.wasm
/* @ts-self-types="./mmlabc_to_smf_wasm.d.ts" */
 ...
 * @param {string} parse_tree_json
 * @param {string} _mml_source
 * @returns {string}
 */
export function parse_tree_json_to_attachment_json(parse_tree_json, _mml_source) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(parse_tree_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(_mml_source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.parse_tree_json_to_attachment_json(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {Uint8Array}
 */
export function parse_tree_json_to_smf(parse_tree_json, _mml_source) {
    const ptr0 = passStringToWasm0(parse_tree_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(_mml_source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.parse_tree_json_to_smf(ptr0, len0, ptr1, len1);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./mmlabc_to_smf_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('mmlabc_to_smf_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
