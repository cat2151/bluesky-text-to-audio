// @generated parser from cat2151/obsidian-plugin-mmlabc (main branch)
// Upstream: https://github.com/cat2151/obsidian-plugin-mmlabc
// Upstream-File: mml/mml2abc.mjs
// Upstream-SHA: 3bb547328de02925dd9b9f13caea8bf0ae3930df
// License: MIT (https://github.com/cat2151/obsidian-plugin-mmlabc/blob/main/LICENSE)
//
// Copy mml/mml2abc.mjs from upstream main here as src/vendor/mml2abc.mjs (with this header).
// DO NOT EDIT this file manually. Re-copy from upstream main to update.
//
...
function peg$parse(input, options) {
  ...
  var peg$e21 = peg$classExpectation([["a", "g"]], false, false);
  ...
  var peg$f0 = function(mmls) { return createAbc(mmls.join('')); };
