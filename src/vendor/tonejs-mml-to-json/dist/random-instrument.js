...
// Upstream-File: dist/random-instrument.js
...
const DEFAULT_INSTRUMENTS = defaultInstruments;
const DEFAULT_EFFECTS = defaultEffects;
function randomizeParams(parameters) {
    const values = {};
 ...
 */
export function randomEffectMml(config) {
    const allEffects = config?.effects ?? DEFAULT_EFFECTS;
 ...
 *   empty effects list.
 */
export function randomInstrumentAndEffectMml(config) {
    return {
