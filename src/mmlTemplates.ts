// @generated templates from cat2151/easymmlabc (main branch)
// Upstream: https://github.com/cat2151/easymmlabc
// Upstream-File: mmlTemplates.js
// Upstream-SHA: 21448e015a54c1495f1357f58b0cd3ead00034e9
// DO NOT EDIT this file manually. Re-copy mmlTemplates.js from upstream main and add `export const mmlTemplates: [string, string][] = ` to update.

export const mmlTemplates: [string, string][] = [
  ["テンプレートを選んでください",
  ``],
  ...
  ["PC087 Lead 8 (bass and lead) 404", `@087c1`],
